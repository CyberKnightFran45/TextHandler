...
<c>PvZ Free and PvZ 2 (v1.0.0 - v6.7.1)</c> </summary> */
...
public static List<string> ReadList(Stream reader, LawnStringsEncoding encodeFlags)
{
List<string> lst = new();
...
public static Dictionary<string, string> ReadDict(Stream reader, LawnStringsEncoding encodeFlags)
{
...
public static int WriteList(Stream writer, List<string> lst, LawnStringsEncoding encodeFlags)
{
...
public static int WriteDict(Stream writer, Dictionary<string, string> dict,
...
public static int WriteKvp(Stream writer, IEnumerable<KeyValuePair<string, string>> map,
                           LawnStringsEncoding encodeFlags)
{
